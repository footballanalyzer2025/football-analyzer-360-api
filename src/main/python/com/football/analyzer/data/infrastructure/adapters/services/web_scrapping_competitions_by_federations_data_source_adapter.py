...
from main.python.com.football.analyzer.data.application.services.web_scrapping.web_scrapping_competitions_by_federations_orchestrator_service import WebScrappingCompetitionsByFederationsOrchestratorService
