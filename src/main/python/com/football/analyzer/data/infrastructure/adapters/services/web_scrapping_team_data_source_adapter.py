...
from main.python.com.football.analyzer.data.application.services.web_scrapping.web_scrapping_team_orchestrator_service import WebScrappingTeamOrchestratorService
...
class WebScrappingTeamDataSourceAdapter(DataSourcePort):
    ...
    def __init__(
        ...
        self.web_scrapping_team_orchestrator_service = WebScrappingTeamOrchestratorService(
    ...
    def get_main_data(self, teams_data: Dict) -> Dict[str, Any]:
        return self.web_scrapping_team_orchestrator_service.execute(teams_data)
